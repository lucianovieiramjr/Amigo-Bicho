...
<html>
    <head>    
        <title>AMIGO BICHO: Pesquisar Fornecedor</title>
        <meta charset="UTF-8">
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                if (document.getElementById("telCelular").checked){
                    ...
                    document.getElementById("telefoneFornecedor").class = "telefoneCelular";
                } else {
                    document.getElementById("formTelefone").action = "../basicos/Cabecalho.php";
                    document.getElementById("telefoneFornecedor").class = "telefoneFixo";
                }
            });
        </script>
        <style>
            .inputPesquisa, #telefoneFornecedor{height: 45px; font-weight: bold; font-size: 120%;}
        ...
        <div class="w3-padding-large" id="main">
            ...
            <div style="margin: 0 auto; width: 75%; margin-top: 5%">
                    ...
                    <div id="divPesquisaNome"> 
                        <center>
                            <div style="padding-bottom: 20px;">
                                <form method="post" action="ResultadoPesquisaNomeFantasiaFornecedor.php">
                                    <br><input class="inputPesquisa" align="left" type="text" name="nomeFantasiaFornecedor" size="50" required placeholder="Insira aqui o nome fantasia do fornecedor">
                                    <button title="Pesquisar" type="submit" class="fa fa-search" style="height: 45px; width: 55px; font-size:120%"></button>
                                </form>
                            </div>
                        </center>
                    </div>
                    <div id="divPesquisaCNPJ"> 
                        <center>
                            <div style="padding-bottom: 20px;">
                                <form method="post" action="ResultadoPesquisaCnpjFornecedor.php">
                                    <br><input id="cnpj" class="inputPesquisa" align="left" type="text" name="cnpjFornecedor" size="50" required placeholder="Insira aqui o CNPJ do fornecedor">
                                    <button title="Pesquisar" type="submit" class="fa fa-search" style="height: 45px; width: 55px; font-size:120%"></button>
                                </form>
                            </div>
                        </center>				
                        ...
                        <center>
                            <div style="padding-bottom: 20px;">
                                <form method="post" action="" id="formTelefone">
                                    ...
                                    <br><input id="telefoneFornecedor" class="telefoneFixo" align="left" type="text" name="telefoneFuncionario" size="50" required placeholder="Insira aqui o telefone do funcionário">
                                    <button title="Pesquisar" type="submit" class="fa fa-search" style="height: 45px; width: 55px; font-size:120%"></button>
                                </form>
                                <span>
                                    - Colocar as opções de telefone fixo e celular e pesquisar o telefone que tiver selecionado, daí muda a máscara do input
                                </span>
                            </div>
                        </center>
                    </div>
                ...
                <script>
                    ...
                    aba.addTab("divPesquisaNome", "&nbsp; PESQUISAR POR NOME FANTASIA &nbsp;");
                    aba.addTab("divPesquisaCNPJ", "&nbsp; PESQUISAR POR CNPJ &nbsp;");
