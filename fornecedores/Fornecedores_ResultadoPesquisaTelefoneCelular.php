...
<html>
    <head>    
        <title>AMIGO BICHO: Resultado de pesquisa por telefone celular de fornecedor</title>
        <meta charset="UTF-8">
    ...
    <body class="div1" onload="mascaras(), horarioRodape(), clima(), fechaOverlayExcluir()">
        ...
        <div id="overlay">
            <div id="textOverlay">
                ...
                <form action="">
                    <p style="text-align: center; color: white; font-size: 180%">Tem certeza de que deseja excluir <br> <span id="nomePopUp">[Nome do fornecedor] </span> <br> da lista de Fornecedores?</p>
