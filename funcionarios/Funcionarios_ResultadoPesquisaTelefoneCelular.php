...
<html>
    <head>    
        <title>AMIGO BICHO: Resultado de pesquisa por telefone celular de funcionário</title>
        <meta charset="UTF-8">
        ...
        <style>
            ...
            .thNome, .thData, .thCpf, .thTelefone{text-align: left;}
            .thNome{width: 330px;}
            .thCpf{width: 200px;}
            .thData{width: 200px;}
            .thTelefone{width: 200px;}
    ...
    <body class="div1" onload="mascaras(), horarioRodape(), clima(), fechaOverlayExcluir()">
        ...
        <div style="margin-right: 25px; margin-left:145px;">
            <p style="font-size: 120%">Exibindo resultados para "<span id="TelefoneCelularFuncionarioPesquisado" style="font-weight: bold; color: #000033;">(22)99105-9478</span>"</p>
            ...
            <table style="font-size: 120%; padding-top: 10px;">
                ...
                <tr>
                    ...
                    <td class="telefoneCelularFuncionario"><span id="telefoneCelularFuncionario"> (22)99105-9478 </span></td>
