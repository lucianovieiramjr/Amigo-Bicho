...
<html>
    <head>    
        <title>AMIGO BICHO: Resultado de pesquisa por telefone fixo de funcionário</title>
        <meta charset="UTF-8">
    ...
    <body class="div1" onload="mascaras(), horarioRodape(), clima(), fechaOverlayExcluir()">
        ...
        <div style="margin-right: 25px; margin-left:145px;">
            <p style="font-size: 120%">Exibindo resultados para "<span id="TelefoneFixoFuncionarioPesquisado" style="font-weight: bold; color: #000033;">(22)2222-2222</span>"</p>
            ...
            <table style="font-size: 120%; padding-top: 10px;">
                ...
                <tr>
                    ...
                    <td class="telefoneFixoFuncionario"><span id="telefoneFixoFuncionario"> (22)2222-2222 </span></td>
